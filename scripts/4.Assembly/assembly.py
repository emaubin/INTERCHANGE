...
class Assembler():
    ...
    def convert_pairedend(self,prog_dir,good_reads,reads):
        ...
        os.system(f"{prog_dir}/INTERCHANGE-V.1.0/Tools/getSeq.py -f {reads} -l {good_reads}_1.id -o {good_reads}_1.fa")
        os.system(f"{prog_dir}/INTERCHANGE-V.1.0/Tools/getSeq.py -f {reads} -l {good_reads}_2.id -o {good_reads}_2.fa")
        return
